...
#original link: https://www.loggly.com/install/configure-linux.sh
curl -s -o configure-linux.sh https://raw.githubusercontent.com/directivegames/install-script/directive/Linux%20Script/configure-linux.sh
